        ...
        <Row>
          ...
          >
            ...
            <p
              ...
              style={{ marginBottom: "6rem", textAlign: "justify" }}
            >
              Having problem with the service? Just pick up the number below to
              have a chat or kindly email us at
              {/* <span
                style={{
                  color: "darkblue",
                  display: "flex",
              ...
              > */}{" "}
              <a
                href="mailto:anup.business7@gmail.com"
                style={{
                  textDecoration: "none",
                  color: "darkblue",
                  display: "flex",
                ...
                rel="noreferrer"
              >
                anup.business7@gmail.com
              </a>
              {/* </span> */}
            </p>
            <p style={{ color: "darkblue" }}>+977 9846877737</p>
          </Col>
          <Col
            style={{
              background: "#faf6f6",
