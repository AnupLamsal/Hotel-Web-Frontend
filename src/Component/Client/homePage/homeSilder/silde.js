          ...
          <>
            ...
            <div className={classes.whyChoose}>
              ...
              >
                ...
                >
                  A world away from the everyday, PRABANDHAK creates the time
                  and space for you to rediscover the meaning of relaxation,
                  well taken care of by our attentive yet discreet hospitality.{" "}
                  <br />
                  Designed in harmony with the natural environment, the resort
                  seamlessly blends traditional Nepali architecture with
                  contemporary elegance and modern comforts. Luxuriate in the
                  privacy of the resort’s beachfront and over-water villas that
                  offer an oasis just steps from the sand, or the pleasure of
                  slipping straight from your deck into the cool, clear waters
                  to reach your own private lagoon.
                </Typography>
              </Paper>
            </div>
            <Footer />
